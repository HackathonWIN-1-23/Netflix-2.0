    ...
    <div>
      ...
      <div v-if="showImages && showImages.length> 0">
        <div class="background__wrapper">
          <img :src="showImages[0]?.resolutions?.original?.url"
               :style="`height: calc(100vh - ${this.inputStore.headerHeight}px)`">
        </div>
      </div>
      <div v-if="show" class="film-wrapper">
        <div class="item-image">
          <img
              :src="show?.image?.original || 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/1665px-No-Image-Placeholder.svg.png' "
              alt="">
        </div>
